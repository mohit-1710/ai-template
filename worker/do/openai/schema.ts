...
const SimpleRectangleShape = z.object({
  ...
  width: z.number(),
  height: z.number(),
  color: z.union([SimpleColor, z.null()]),
  fill: z.union([SimpleFill, z.null()]),
  text: z.union([SimpleLabel, z.null()]),
})
...
const SimpleTextShape = z.object({
  ...
  color: z.union([SimpleColor, z.null()]),
  text: z.union([SimpleLabel, z.null()]),
  textAlign: z.union([z.enum(['start', 'middle', 'end']), z.null()]),
})
...
const SimpleArrowShape = z.object({
  ...
  shapeId: z.string(),
  note: z.string(),
  fromId: z.union([z.string(), z.null()]),
  toId: z.union([z.string(), z.null()]),
  x1: z.number(),
  y1: z.number(),
  x2: z.number(),
  y2: z.number(),
